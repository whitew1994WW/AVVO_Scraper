...
curl -v 'https://www.avvo.com/all-lawyers/sitemap.xml?page=0' -H 'User-Agent: notanagent' -H 'Accept-Language: en-GB,en;q=0.5'  -H 'Upgrade-Insecure-Requests: 1' -H 'TE: trailers' --output test.html
